...
export default function Home() {
  ...
  function updateBgColor(scrollPos) {
    ...
    // new RGB
    const [r, g, b] = [sr + dr * perc, sg + dg * perc, sb + db * perc].map(
      Math.round
    );
    setBgColor(`${r}, ${g}, ${b}`);
  }
  ...
  return (
    ...
    >
      <Head>
        ...
        <meta
          name="description"
          content="Buoyant is a protocol for on-chain subscriptions built on Solana."
        />
        <meta
          name="keywords"
          content="Crypto, Subscription, Solana, Tradable, NFT, Token, Protocol, Blockchain, Payments"
        />
        ...
        <meta
          name="twitter:card"
          content="Stay afloat. Buoyant is a base protocol for recurring payments built on Solana."
        />
        ...
        <meta
          property="og:image"
          content="https://buoyant.it/images/squid_blue_bg.png"
        />
      </Head>
      ...
      <div className={styles.nav}>
        ...
        <div className={styles.middleNav}>
          <a
            href="https://buoyant.gitbook.io/buoyant/"
            target="_blank"
            rel="noreferrer"
          >
            Docs
      ...
      <div className={styles.center}>
        <img
          className={styles.leftImg + " " + styles.bgFish}
          src="./images/model_squid.png"
        />
      ...
      <div className={styles.center}>
        <img
          className={styles.middleImg + " " + styles.bgFish}
          src="./images/model_turtle.png"
        />
